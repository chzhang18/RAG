...
class newMatching(nn.Module):
    def __init__(self, network_arch, cell_arch, cell=Cell, args=None):        
        ...
        self._step = 3#args.mat_step
        self._num_layers = 8#args.mat_num_layers # 8
        self._block_multiplier = 3#args.mat_block_multiplier # 3
        self._filter_multiplier = 4#args.mat_filter_multiplier # 4
        
        initial_fm = self._filter_multiplier * self._block_multiplier
        half_initial_fm = initial_fm // 2

        self.stem0 = ConvBR_3d(initial_fm*2, initial_fm, 3, stride=1, padding=1)
        self.stem1 = ConvBR_3d(initial_fm, initial_fm, 3, stride=1, padding=1)
        ...
        self.last_3  = ConvBR_3d(initial_fm, 1, 3, 1, 1,  bn=False, relu=False)  
        self.last_6  = ConvBR_3d(initial_fm*2 , initial_fm,    1, 1, 0)  
        self.last_12 = ConvBR_3d(initial_fm*4 , initial_fm*2,  1, 1, 0)  
        self.last_24 = ConvBR_3d(initial_fm*8 , initial_fm*4,  1, 1, 0)  
