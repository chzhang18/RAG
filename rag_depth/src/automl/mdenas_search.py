...
class AutoSearch(object):
    ...
    def train(self, train_queue, batch_size, fea_ops, mat_ops):
        ...
        for step, sample in enumerate(train_queue):
            ...
            mask = disp_gt > 0
            loss = self.silog_criterion.forward(disp_est, disp_gt, mask.to(torch.bool))
            ...
            with torch.no_grad():
                ...
                disp_est = disp_est.cpu().numpy()
                mask = disp_gt > 0
                depth_errors = compute_errors(disp_gt[mask], disp_est[mask])
                ...
                if step % 5 == 0:
                    ...
                    print('train: {} loss: {} abs_rel: {} rmse: {}'.format(step, loss.item(), depth_errors[1], depth_errors[3]))
        ...
        return abs_rel_avg, loss_avg, rmse_avg
